...
const en: Dict = {
  ...
  "nav.stats": "Stats",
  "nav.about": "About",
  "home.badge": "Modern Minesweeper · 2026",
  ...
  "date.today": "Today",
  "about.title": "About Minesweep",
  "about.intro":
    "Minesweep is a modern take on the classic Minesweeper. Most online versions look like Windows 95 — we wanted one that feels at home on a 2026 browser: clean typography, smooth interactions, dark mode by default, and a fully responsive board that scales to your screen.",
...
const ru: Dict = {
  ...
  "nav.about": "О проекте",
  "home.badge": "Современный Сапёр · 2026",
  "home.title.a": "Сапёр со ",
  "home.title.b": "стилем",
  ...
  "date.today": "Сегодня",
  "about.title": "О Minesweep",
  "about.intro":
    "Minesweep — современная версия классического Сапёра. Большинство онлайн-версий выглядят как Windows 95, а мы хотели вариант, который смотрится на своём месте в браузере 2026 года: аккуратная типографика, плавные взаимодействия, тёмная тема по умолчанию и адаптивное поле под любой экран.",
...
const kk: Dict = {
  ...
  "home.badge": "Заманауи Сапёр · 2026",
  "home.title.a": "Стильмен ",
  "home.title.b": "ойнаңыз",
  ...
  "date.today": "Бүгін",
  "about.title": "Minesweep туралы",
  "about.intro":
    "Minesweep — классикалық Сапёрдың заманауи нұсқасы. Көптеген онлайн нұсқалар Windows 95 сияқты көрінеді, ал біз 2026 жылғы браузерге лайық нұсқа жасадық: таза типографика, тегіс әрекеттестік, әдепкі қара тақырып және кез келген экранға бейімделетін тақта.",
